export const translations = {
    ...
    // Hero
    title: 'Студія Розробки',
    subtitle: 'Професійна розробка веб-сайтів, додатків та дизайну. Ми створюємо сучасні, функціональні та красиві рішення для вашого бізнесу. Інновації та креативність у кожному проекті.',
    ...
    webDev: {
      title: 'Веб-розробка',
      description: 'Створення сучасних, адаптивних веб-сайтів з використанням найновіших технологій. Від лендінгів до складних веб-додатків з повним функціоналом.'
    },
    mobileDev: {
      title: 'Мобільні додатки',
      description: 'Розробка мобільних додатків для iOS та Android. Нативні та крос-платформені рішення для вашого бізнесу з інтуїтивним інтерфейсом.'
    },
    design: {
      title: 'UI/UX Дизайн',
      description: 'Створення інтуїтивного та привабливого користувацького інтерфейсу. Прототипування, тестування та оптимізація користувацького досвіду.'
    },
    ecommerce: {
      title: 'E-commerce',
      description: 'Розробка інтернет-магазинів з повним функціоналом. Інтеграція з платіжними системами, CRM та системами управління товарами.'
    },
    seo: {
      title: 'SEO Оптимізація',
      description: 'Підвищення видимості сайту в пошукових системах. Технічна оптимізація, контент-стратегія та аналітика для зростання трафіку.'
    },
    consulting: {
      title: 'Консультації',
      description: 'Професійні консультації з питань технологій, архітектури проекту та стратегії цифрової трансформації вашого бізнесу.'
    },
    ...
    // About
    aboutTitle: 'Про нас',
    aboutSubtitle: 'Ми перетворюємо ідеї в реальність',
    aboutDescription: 'Ми спеціалізуємося на реалізації складних проектів, але не обмежуємося ними - від лендінгів до складних веб-додатків, втілюємо будь-які ідеї.',
    
    specialization: {
      title: 'Спеціалізація',
      description: 'Ми спеціалізуємося на реалізації складних проектів, але не обмежуємося ними - від лендінгів до складних веб-додатків, втілюємо будь-які ідеї.'
    },
    
    cost: {
      title: 'Вартість',
      description: 'Мінімальна вартість замовлення починається від $500. Час виконання залежить від складності проекту.'
    },
    
    payment: {
      title: 'Оплата',
      description: 'Приймаємо оплату зручними для вас способами, починаючи від банківських карт, закінчуючи криптовалютами.'
    },
    
    stack: {
      title: 'Технології',
      description: 'Основні мови в нашому арсеналі - JavaScript, React, Node.js та Python. Потрібно щось інше? Просто скажіть - ми знайдемо рішення!'
    },
